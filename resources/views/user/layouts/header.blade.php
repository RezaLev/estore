            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    document.getElementById('userDropdown').addEventListener('click', function() {
                        document.querySelector('[data-target="userDropdown"]').classList.toggle('show')
                    })
                });
            </script>
            <!-- Dropdown - User Information -->
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" data-target="userDropdown"
