    ...
    @if ($order)
                ...
                <tbody>
                    @foreach ($order->cart_info as $cart)
                        ...
                        <tr>
                            ...
                            <td><span>{{ Helper::rupiahFormatter($cart->price, 2) }}</span></td>
                        </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th scope="col"> <span>{{ Helper::rupiahFormatter($order->sub_total, 2) }}</span></th>
                    </tr>
      ...
      @endif --}}
                    <tr>
                        ...
                        <th><span>{{ Helper::rupiahFormatter($order->delivery_charge, 2) }}</span></th>
                    </tr>
                    <tr>
                        <th scope="col" class="empty"></th>
                        ...
                        <th>
                            <span>
                                {{ Helper::rupiahFormatter($order->total_amount, 2) }}
                            </span>
                        </th>
                    </tr>
                </tfoot>
