...
@section('title','GriyaBambu || All Notifications')
    ...
    <table class="table  table-hover admin-table" id="notification-dataTable">
      ...
      <tbody>
        ...
        <tr class="@if($notification->unread()) bg-light border-left-light @else border-left-success @endif">
          ...
          <td>
            <a href="{{route('admin.notification', $notification->id) }}" class="btn btn-primary btn-sm float-left mr-1 viewNotification" style="height:30px; width:30px;border-radius:50%" data-id="{{$notification->id}}" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
          ...
          $('.viewNotification').click(function(e) {
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      $('#messageCounter').attr('data-count', '0').text('0');
                  },
                  error: function(xhr) {
