...
@endsection
@section('title', 'GriyaBambu || PRODUCT DETAIL')
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="product-des">
                                ...
                                <div class="short">
                                    ...
                                    @endphp
                                    <p class="price"><span
                                            class="discount">{{ Helper::rupiahFormatter($after_discount, 2) }}</span><s>{{ Helper::rupiahFormatter($product_detail->price, 2) }}</s>
                                    </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">{{ Helper::rupiahFormatter($data->price, 2) }}</span>
