...
@section('title','GriyaBambu || Register Page')
...
@section('main-content')
    ...
    <!-- Shop Login -->
    <section class="shop login section bg-secondary">
        <div class="container">
            <div class="row">
                    ...
                    <div class="login-form">
                        ...
                        <form class="form" method="post" action="{{ route('register.submit') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="checkbox">
                                        <label class="checkbox-inline" for="is_agent">
                                            <input name="is_agent" id="is_agent" type="checkbox">Register as Agent
                                        </label>
                                    </div>
                                </div>
                                <div class="col-12">
